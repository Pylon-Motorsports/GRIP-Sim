...
const min_gas_force_per_second = 50.0
const max_gas_force_per_second = 10000.0
const max_engine_brake_force_per_second = 100.0
...
func _physics_process(delta):
    ...
    var gas_force = (min_gas_force_per_second + ((max_gas_force_per_second - min_gas_force_per_second) * (rpm / max_rpm))) * delta * gas
